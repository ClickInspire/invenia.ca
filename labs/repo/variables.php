...
<a href="swap.php">Swap Variables</a><br><br><br>
Warning: do not modify the field permissions. One has to have an attribute name "Permissions" with options "Public" and "Private"<br><br>
